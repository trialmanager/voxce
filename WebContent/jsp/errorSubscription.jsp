...
<body>
	...
	<div class="wrapper">
		...
		<div class="menu_bar">
			<div class="top_menu_set">
				...
				<a href="javascript://" class="current_btn"><span>Get
						Subscription</span></a>
	...
	<a href="<c:url value='ShowCRFIndex.crf?CurrentForm=add_question_form' />" class="top_btn"><span>Form</span></a>-->
			</div>
		...
		<div class="body_content">
			...
			<div align="centor" class="" id="mainFormsDiv"
				...
				<img src="images/alert.png" alt=""
					...
					<div>Your Request is not Submitted, Please Contact To The
						Admin!</div>
			</div>
