					...
					<div class="nav_menu">
						...
						<c:if test="${tl:rightsofView(resourceList,'View Document')==1}">
							<a href="<c:url value='OpenStudyDocuments.study' />"
								class="nav_l" name="" id="current">Documents</a>
						</c:if>
						<c:if
					...
					<div class="create_group_container">
						<div id="" class="myform study">
							<form id="file_upload" enctype="multipart/form-data"
								action="uploaddocument.study" method="POST">
								<br /> <br /> <br /> <br />
								<fieldset id="file_upload">
									...
									<label style="font-weight: bold;">Select File</label> <input
										...
										id="fileUploadError" class="error_label">${ErrorMessage}</span>
									<div></div>
								...
								<table width="100%" border="0" cellspacing="1" cellpadding="0"
									...
									<tr class="rights_header_view_list">
										...
										<td width="23%" align="left" valign="middle">&nbsp;Upload
											Date</td>
										<c:if
											test="${tl:rightsofView(resourceList,'Download Document')==1 }">
											<td width="10%" align="center" valign="middle">Download</td>
										</c:if>
										<c:if
											test="${tl:rightsofView(resourceList,'Delete Document')==1 }">
											...
											<tr class="${tempRowStyle}" id="${doc.study_document_id}">
												...
												<c:if
													...
													<td valign="top" align="center" class="set_padding2">
														<a
														href="<c:url value='DownloadDocument.study?docid=${doc.study_document_id}'/>">
															<img src="images/download.png" alt="Doc" title="Doc"
															border="0" />
													</a>
													</td>
												</c:if>
												<c:if
													...
													<td valign="top" align="center" class="set_padding2">
														<a
														href="<c:url value='DeleteDocument.study?docid=${doc.study_document_id}' />"><img
