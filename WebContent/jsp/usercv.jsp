...
<body>
	...
	%>
	<input type="hidden" name="usercv_form" id="usercv_form"
		value="${CurrentFormUserCV}" />
	<input type="hidden" name="ApprovalStatusMessage"
		id="ApprovalStatusMessage" value="${MessageCode}" />
	<input type="hidden" name="CVstatus" id="CVstatus" value="${true}" />
	<input type="hidden" name="rowcount" id="rowcount" value="0" />
	<input type="hidden" name="edit_1" id="edit_1" value="0" />
	...
	<div class="wrapper">
		...
		<div class="body_content">
			...
			<div class="right_body_content" id="mainFormsDiv">
				...
				<div class="body_inner" id="View_UserCV_div" style="display: none;">
					...
					<div class="create_group_container">
						...
						<div class="field_set">
							<input id="View_User_CV_bar" name="View_User_CV_bar" type="text"
						...
						<div class="show_hide_form">
							...
							<span id="Edit_UserCV_Error" class="error_label_grp"
								style="display: none;">${EEMessage}</span> <span
								id="Edit_UserCV_Success" class="chk_avail_yes"
								style="display: none;">${ESMessage}</span>
							...
							<div class="field_txt_view_list">
								...
								<table id="View_user_Table" width="100%" border="0"
									...
									<tbody id="fbody4">
										...
										<c:forEach items="${usercvlist}" var="usercvlist"
											varStatus="status">
											<c:set var="tempRowStyle"
												value="${(status.index)%2 eq 0?'white_row_view_list':'grey_row_view_list'}" />
											<tr class="${tempRowStyle}" id="${usercvlist.user_cv_id}">
												<td valign="top" align="left" class="set_padding"><c:forEach
														items="${userslist}" var="users" varStatus="status">
														<c:if test="${usercvlist.user_id == users.user_id}">
	           							${users.first_name} ${users.middle_name} ${users.last_name}
	           					</c:if>
													</c:forEach></td>
												<td valign="top" align="left" class="set_padding">${usercvlist.received_dt}</td>
												<td valign="top" align="center" class="set_padding2"><a
													href="<c:url value='DownloadDocumentUseCV.trial?docid=${usercvlist.user_cv_id}'/>"><img
														src="images/download.png" alt="Doc" title="Doc" border="0" /></a></td>
												<td valign="top" align="center" class="set_padding2"><img
													onclick="edit_view_usercv_row('${usercvlist.user_cv_id}','${usercvlist.user_id}','${usercvlist.study_id}','${usercvlist.received_dt}','${usercvlist.date_created}','${usercvlist.created_by}','${usercvlist.filename}','${usercvlist.file_description}')"
				...
				<!-- 												Start Create UserCV-->
				<!-- 												Start Create UserCV-->
				<div class="body_inner" id="Create_UserCV_div"
					style="display: none;">
					<div class="body_inner_header">
						<!-- ************************Navigation***************************************** -->
						<div class="crumb_left"></div>
						<div class="crumb_mid">
							...
							<div class="crumbs-link">
								<a href="#" id="create_usercv_title">Create UserCV</a>
							</div>
						</div>
						<div class="crumb_right"></div>
						<!-- ************************Navigation******************************* -->
					...
					<div class="create_group_container">
						<div id="" class="myform visit">
							<form id="file_upload_1" name="file_upload_1"
								enctype="multipart/form-data" method="post"
								action="SubmitUserCV.trial" class="visit">
								<span id="UserCV_Error" class="error_label_grp"
									style="display: none;"></span> <span id="UserCV_Success"
									class="chk_avail_yes" style="display: none;"></span> <label>Choose
									a File to upload</label> <input type="file" name="file_1" id="file_1"
									value="" style="width: 400px; margin-left: 20px;"
									class="input_txt" /><span id="usercvfileUploadError"
									class="error_label"></span>

								<div style="float: left; clear: both;">
									<table id="files_1" style="width: 596px;" border="0"
										cellspacing="1" cellpadding="0" class="table_border_view_list" style=""></table>
								</div>
								<div class="spacer"></div>
							</form>

							<form id="Create_UserCV" name="Create_UserCV" method="post"
								class="visit" action="CreateUserCV.trial">
								<input name="usercv_edit_id" id="usercv_edit_id" type="text"
									value="0" class="input_txt" style="display: none" /> <input
									name="usercv_date_created" id="usercv_date_created" type="text"
									value="0" class="input_txt" style="display: none" /> <input
									name="usercv_created_by" id="usercv_created_by" type="text"
									value="0" class="input_txt" style="display: none" /> <input
									name="upload_cv" id="upload_cv" type="text" value="0"
									class="input_txt" style="display: none" /> <label>File
									Description :</label>
								<textarea id="cv_file_description" name="cv_file_description"
									cols="" rows=""
									onkeyup="if (this.value.length > 250)this.value = this.value.substring(0, 250)"
									class="textareafile">
</textarea>
								<span id="cv_file_description_error" class="error_label_grp"></span>
								<label>User :</label> <select name="user_id" id="user_id"
									class="drop_txt">
								...
								</select> <span id="user_id_error" class="error_label_grp"></span> <label>Received
									Date :</label> <input readonly="readonly" id="received_date"
									name="received_date" type="text" value="" class="input_txt"
									style="width: 100px;" /><img src="images/calender.png" alt=""
									border="0" style="float: left; margin: 0;" /><span
									id="received_date_error" class="error_label"></span>
								...
								<div style="clear: both; margin-top: 10px; padding-left: 170px;">
									...
									<button class="grey-pill" type="reset"
										onclick="LoadTrialsForm('View_UserCV_div')">Cancel</button>
								</div>
							</form>
